...
class SearchClassesScreen extends ConsumerStatefulWidget {
  const SearchClassesScreen({super.key});

  @override
  ConsumerState<SearchClassesScreen> createState() => _SearchClassesScreenState();
}

class _SearchClassesScreenState extends ConsumerState<SearchClassesScreen> {
  String _query = '';
